...
public class FormService extends BaseService {
	...
	@EndpointMethod(uri = "/new-application-form-section", bodyParams = { "name", "realm" }, method = HttpMethod.PUT, 
	...
	@EndpointMethod(uri = "/list-application-form-sections", requestParams = {"realm" }, 
	...
	@EndpointMethod(uri = "/list-system-configuration-sections", 
	...
	@EndpointMethod(uri = "/list-application-form-fields", requestParams = {"sectionId" }, 
			functionality = Functionality.VIEW_APPLICATION_FORM)
	...
	@EndpointMethod(uri = "/list-all-application-form-fields", bodyParams = {"sectionIds" }, method = HttpMethod.POST, 
			functionality = Functionality.VIEW_APPLICATION_FORM)
	...
	@EndpointMethod(uri = "/list-system-configuration-fields", requestParams = {"sectionId" }, 
			functionality = Functionality.VIEW_SYSTEM_CONFIGURATION)
	...
	@EndpointMethod(uri = "/list-all-system-configuration-fields", bodyParams = {"sectionIds" }, method = HttpMethod.POST, 
			functionality = Functionality.VIEW_SYSTEM_CONFIGURATION)
	...
	@EndpointMethod(uri = "/delete-application-form-section", requestParams = {"sectionId"}, method = HttpMethod.DELETE,
			functionality = Functionality.MANAGE_APPLICATION_FORMS)
	...
	@EndpointMethod(uri = "/delete-system-configuration-section", requestParams = {"sectionId"}, method = HttpMethod.DELETE,
	...
	@EndpointMethod(uri = "/delete-application-form-field", requestParams = {"fieldId"}, method = HttpMethod.DELETE,
			functionality = Functionality.MANAGE_APPLICATION_FORMS)
	...
	@EndpointMethod(uri = "/delete-system-configuration-field", requestParams = {"fieldId" }, method =  HttpMethod.DELETE,
			functionality = Functionality.MANAGE_SYSTEM_CONFIGURATION_FORM)
	...
	@EndpointMethod(uri = "/create-application-form-simple-field", bodyParams = {"sectionId", "spec" }, method = HttpMethod.PUT, 
			functionality = Functionality.MANAGE_APPLICATION_FORMS)
	...
	@EndpointMethod(uri = "/create-application-form-composite-field", bodyParams = {"sectionId", "spec" }, method = HttpMethod.PUT, 
			functionality = Functionality.MANAGE_APPLICATION_FORMS)
	...
	@EndpointMethod(uri = "/create-system-configuration-simple-field", bodyParams = {"sectionId", "spec" }, method = HttpMethod.PUT, 
			functionality = Functionality.MANAGE_SYSTEM_CONFIGURATION_FORM)
	...
	@EndpointMethod(uri = "/create-system-configuration-composite-field", bodyParams = {"sectionId", "spec" }, method = HttpMethod.PUT, 
			functionality = Functionality.MANAGE_SYSTEM_CONFIGURATION_FORM)
